...
class Catalogo:
    ...
    def consultar_producto(self, codigo):
       ...
       #return jsonify({hola:2})
        #return jsonify(dict(hola=2))
    #----------------------------------------------------------------
...
catalogo = Catalogo(host=HOST, user=USER, password=PASSWORD, database=DATABASE)
#catalogo = Catalogo(host='localhost', user='root', password='admin', database='catalogo')
...
RUTA_DESTINO = '/home/evelyngaitan22/static/imagenes'
